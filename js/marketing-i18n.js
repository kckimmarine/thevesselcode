...
(function (global) {
    ...
    const T = {
        ...
        'footer.signature': {
            en: 'The Vessel Code is an engineering commons and fleet operating architecture designed by (1st Class Marine Engineer License / Chief Engineer / Superintendent).',
            ko: 'The Vessel Code는 (1급 기관사 면허 / 기관장 / 공무감독) 자격을 바탕으로 설계한 엔지니어링 커먼즈 및 선대 운영 아키텍처입니다.',
        },
        ...
        'home.metrics.specs': { en: '<strong>53,000+</strong> Specs', ko: '<strong>53,000+</strong> 스펙' },
        ...
        'home.utility.impa': { en: '📦 53,000+ IMPA Plates', ko: '📦 53,000+ IMPA 도판' },
        ...
        'home.digital.tk.d': {
            en: 'Free IMPA catalog (53,000+ codes), bunker, lube, paint & flange tools.',
            ko: '무료 IMPA 53,000+ 코드, 벙커·플랜지 등 실무 도구.',
        },
        ...
        'tk.mod.catalog.d': { en: '53,000+ spec pages with catalog plates.', ko: '5.3만+ 규격·도판 페이지.' },
        ...
        'tk.feature.impa': {
            en: '53,000+ IMPA store specs &amp; catalog plates — fast search',
