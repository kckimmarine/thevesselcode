...
(function (global) {
    ...
    const T = {
        ...
        'footer.signature': {
            en: 'The Vessel Code is an engineering commons and fleet operating architecture designed by Kim Kyeong-cheol (1st Class Marine Engineer / Technical Superintendent).',
            ko: 'The Vessel Code는 1급 기관사·기술공무감독 김경철이 설계한 엔지니어링 커먼즈 및 선대 운영 아키텍처입니다.',
        },
        ...
        'home.headline': { en: 'THE VESSEL CODE', ko: 'THE VESSEL CODE' },
        'home.subtitle': {
            en: 'Marine Engineering Knowledge Base & Fleet Operating Tools.',
            ko: '해양 엔지니어링 지식 기반 & 선대 운영 도구.',
        },
        'home.tagline': {
        ...
        'home.utility.bunker': { en: 'ASTM 54B Bunker', ko: 'ASTM 54B 벙커' },
        'home.utility.flange': { en: 'JIS / ANSI Flange', ko: 'JIS / ANSI 플랜지' },
        ...
        'home.document.title': {
            en: 'THE VESSEL CODE | Marine Engineering Knowledge Base',
            ko: 'THE VESSEL CODE | 해양 엔지니어링 지식 기반',
        },
        ...
        'tk.mod.5.title': { en: 'Electrical & Control', ko: '전기·제어' },
        'tk.mod.5.d': { en: 'Motor full-load current (FLC) estimate and PT100 R–T reference.', ko: '전동기 FLC 추정 및 PT100 저항–온도표.' },
        ...
        'tk.electrical.title': { en: 'Electrical & control diagnostics', ko: '전기·제어 진단' },
        'tk.electrical.sub': {
            en: 'Three-phase motor full-load current (FLC) estimate and PT100 resistance–temperature (IEC 60751, α = 0.00385).',
            ko: '3상 전동기 FLC 추정 및 PT100 저항–온도 (IEC 60751).',
        },
        ...
        'tk.electrical.flc': { en: 'Est. FLC (A)', ko: '추정 FLC (A)' },
        'tk.electrical.pt100': { en: 'PT100 resistance vs temperature', ko: 'PT100 저항–온도' },
        'tk.electrical.note': {
            en: 'FLC is indicative — use nameplate, class rules, and cable sizing standards before alteration.',
            ko: 'FLC는 참고값입니다. 변경 전 명판·선급·케이블 기준을 확인하세요.',
        },
