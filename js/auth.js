...
const TVC_Auth = (function () {
    ...
    const USERS_SEED_VERSION = 24;

    const DEFAULT_USERS = [
        // Contract vessel — ABC Voyager (demo ship accounts)
        { id: 'user-officer', username: 'officer', display_name: 'Officer', account_type: 'SHIP', role: 'SHIP_OFFICER', department: 'DECK', vessel_id: 'ABC Voyager' },
        { id: 'user-co', username: 'co', display_name: 'Chief officer', account_type: 'SHIP', role: 'SHIP_CO', department: 'DECK', vessel_id: 'ABC Voyager' },
        { id: 'user-engineer', username: 'engineer', display_name: 'Engineer', account_type: 'SHIP', role: 'SHIP_ENGINEER', department: 'ENGINE', vessel_id: 'ABC Voyager' },
        { id: 'user-ce', username: 'ce', display_name: 'Chief engineer', account_type: 'SHIP', role: 'SHIP_CE', department: 'ENGINE', vessel_id: 'ABC Voyager' },
        { id: 'user-captain', username: 'captain', display_name: 'Captain', account_type: 'SHIP', role: 'SHIP_CAPTAIN', department: 'CAPTAIN', vessel_id: 'ABC Voyager' },
        ...
        { id: 'user-swt-sq', username: 'swt-sq', display_name: 'SWT SQ', account_type: 'SM', role: 'SM_SUPERINTENDENT', department: null, vessel_id: null, company_id: 'SWT', seed_password: '0000' },
