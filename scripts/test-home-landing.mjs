...
check('hero benefit headline', home.includes('Ship Management AX') && home.includes('data-i18n="home.headline"'));
check('hero benefit subtitle', home.includes('home.subtitle') && home.includes('unstructured'));
check('home core tech section', home.includes('id="core-tech-ax"') && home.includes('home.coretech.title'));
