...
check('hero headline vessel code', home.includes('THE VESSEL CODE') && home.includes('data-i18n="home.headline"'));
check('hero engineering subtitle', home.includes('home.subtitle') || home.includes('Marine Engineering Knowledge Base'));
