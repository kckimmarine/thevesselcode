...
check('hero toolkit CTA', home.includes('href="/toolkit"') && home.includes('Open Free Maritime Toolkit'));
check('hero sm CTA', home.includes('href="/sm"') && home.includes('Discover TVC-SM Platform'));
check('community ethos banner', home.includes('home-ethos-band') && home.includes('상생 플랫폼'));
