...
check('hero benefit headline', home.includes('Stop Searching Thick Manuals') && home.includes('data-i18n="home.headline"'));
check('hero benefit subtitle', home.includes('home.subtitle') && home.includes('50,000+ IMPA'));
