...
check('ocean transit badge copy', lookupSrc.includes('Ocean Transit • Awaiting Coastal Signal'));
check('last verified position on stale card', lookupSrc.includes('Last verified position'));
